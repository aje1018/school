...
#Pmod Header JXADC
#Sch name = XA1_P
set_property PACKAGE_PIN J3 [get_ports {AUXP6}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {AUXP6}]
#Sch name = XA2_P
set_property PACKAGE_PIN L3 [get_ports {AUXP14}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {AUXP14}]
#Sch name = XA3_P
set_property PACKAGE_PIN M2 [get_ports {AUXP7}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {AUXP7}]
#Sch name = XA4_P
set_property PACKAGE_PIN N2 [get_ports {AUXP15}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {AUXP15}]
#Sch name = XA1_N
set_property PACKAGE_PIN K3 [get_ports {AUXN6}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {AUXN6}]
#Sch name = XA2_N
set_property PACKAGE_PIN M3 [get_ports {AUXN14}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {AUXN14}]
#Sch name = XA3_N
set_property PACKAGE_PIN M1 [get_ports {AUXN7}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {AUXN7}]
#Sch name = XA4_N
set_property PACKAGE_PIN N1 [get_ports {AUXN15}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {AUXN15}]
